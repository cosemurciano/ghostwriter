...
/**
 * Tabella capitoli in stile Articoli: filtro per progetto, viste per stato,
 * ricerca e azioni riga. Va istanziata SOLO al render della pagina: il
 * costruttore di WP_List_Table richiede gli include admin di WordPress.
 */
final class ChaptersListTable extends \WP_List_Table {
